...
const config = {
  ...
  entry: {
    ...
    preamble: PREAMBLE,
    addSlice: addPreamble('/src/addSlice/index.jsx'),//添加用户切片
    explore: addPreamble('/src/explore/index.jsx'),//打包chart的js文件入口
    dashboard: addPreamble('/src/dashboard/index.jsx'),//仪表盘的
    sqllab: addPreamble('/src/SqlLab/index.jsx'),
    welcome: addPreamble('/src/welcome/index.jsx'),//初始登录界面的
  ...
  module: {
    ...
    rules: [
      ...
      {
        test:/(NetGraph\/src)\.(csv|eot|ttf|svg|woff)$/,
        use:{
            loader:'file-loader'
        }
    },
    {
        test:/(NetGraph\/src)\.css$/,
        use:['style-loader','css-loader']
    },
    {
        test: /(NetGraph\/src)\.m?js$/,
