...
class ExploreViewContainer extends React.Component {
  ...
  onQuery() {
    // remove alerts when query ，运行之前先移除之前显示的警告
    this.props.actions.removeControlPanelAlert();
    this.props.actions.triggerQuery(true, this.props.chart.id);
    //这一步仅仅是刷新了store中的一个bool状态的值，没有进行查询
  ...
  onFlash(){
    this.props.actions.removeControlPanelAlert();
    this.props.actions.flashQuery(true, this.props.chart.id);
    this.setState({ chartIsStale: false, refreshOverlayVisible: false });
  }
  ...
  renderChartContainer() {
    //console.log('刷新层遮盖范围',this.state.refreshOverlayVisible)这个一直是false
    return (
      <ExploreChartPanel
          ...
          <div className="col-sm-4">
            ...
            >
              <QueryAndSaveBtns
                ...
                flashQuery={this.props.chart.flashQuery}
...
function mapDispatchToProps(dispatch) {
  ...
  // console.log('两者对比',actions)
  // console.log('两者对比',bindActionCreators(actions, dispatch))
  return {
