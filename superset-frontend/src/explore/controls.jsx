 ...
 * - mapStateToProps: a function that receives the App's state and return an object of k/v
     ...
     这个函数接收App的状态并返回一个k/v对象来在运行时覆盖配置。这对于基于组件外部的任何内容(如另一个控件的值)
     来更改组件非常有用。例如，可以根据另一个组件的值显示警告。还可以通过这种方式将redux存储中的任意数据绑定到组件。
...
const NUMBER_LIMITS = [1,5,15,25,150,500,'加着玩的']
