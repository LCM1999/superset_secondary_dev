...
import MixLineBar from '../explore/controlPanels/MixLineBar';//新加的导出模块路径
import LiuTu from '../explore/controlPanels/LiuTu';
import NetGraph from '../explore/controlPanels/NetGraph';

export default function setupPlugins() {
  new MainPreset().register();//注册并返回一个ChartPlugin类
  ...
  getChartControlPanelRegistry()
    ...
    .registerValue('mix_line_bar', MixLineBar)//注册自己的新chart,控制面板
    .registerValue('liutu', LiuTu)
    .registerValue('net_graph', NetGraph);

  setupPluginsExtra();//空函数，在这个文件的下面一个文件就是
}
