...
def get_form_data(slice_id=None, use_slice_data=False):#获取表单数据
    form_data = {}
    print('this is iouqsadhiw:',request.form)
    ...
    if request_args_data:
        print('This is Request_data:',request_args_data)
    ...
    #当slice_id存在时，从DB加载并覆盖
    # the form_data from the DB with the other form_data provided
    #DB中的form_data和提供的另一个form_data
